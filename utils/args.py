...
def get_parser():
    ...
    parser.add_argument('--dataset', type=str, choices=['defocus', 'DDFF', 'NYU100', 'DSLR', 'SC', 'mobileDFD'], default='NYUv2')
    ...
    parser.add_argument('--dpt_post_op', type=str, choices=['raw', 'clip', 'norm'], default='clip')
    parser.add_argument('--continue_from', type=str, default='')

    parser.add_argument('--eval', action='store_true', default=False)

    parser.add_argument('--pred_param', action='store_true', default=False)
    parser.add_argument('--learn_camera', action='store_true', default=False)
